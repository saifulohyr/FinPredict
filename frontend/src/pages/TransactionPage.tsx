  ...
  return (
    <div className="bg-[#F0F0F0] min-h-screen font-sans text-black p-4 md:p-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start mb-8 gap-6">
        ...
        <div className="bg-black text-[#4ade80] px-4 py-2 border-4 border-black rounded-2xl shadow-[4px_4px_0px_0px_rgba(74,222,128,0.5)] self-start md:self-auto">
        ...
        <div className="col-span-1 md:col-span-12 lg:col-span-5 space-y-8">
          ...
          <div className="bg-[#FFB6C1] border-4 border-black rounded-2xl p-6 md:p-8 shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] text-left">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="bg-black text-white text-[7px] md:text-[8px] font-black px-2 py-1 border-2 border-black rounded-xl uppercase whitespace-nowrap">Auto-Tagging Aktif</span>
              <span className="bg-black text-white text-[7px] md:text-[8px] font-black px-2 py-1 border-2 border-black rounded-xl uppercase whitespace-nowrap">Prediksi Real-Time</span>
            </div>
          </div>
