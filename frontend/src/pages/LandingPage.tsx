...
export function LandingPage() {
  ...
  return (
    <div className="bg-[#F5F5DC] min-h-screen font-sans text-black overflow-x-hidden selection:bg-black selection:text-[#FFFF00]">
      {/* Navbar Minimalis */}
      <nav className="p-6 border-b-8 border-black flex justify-between items-center bg-[#FFFF00]">
      ...
      <header className="px-6 py-20 md:py-32 flex flex-col items-center justify-center text-center border-b-8 border-black bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjAiIGhlaWdodD0iMjAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PGNpcmNsZSBjeD0iMiIgY3k9IjIiIHI9IjIiIGZpbGw9IiMwMDAwMDAiIGZpbGwtb3BhY2l0eT0iMC4wNSIvPjwvc3ZnPg==')]">
        <div className="bg-white border-8 border-black p-8 md:p-16 max-w-4xl shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] rotate-1 hover:rotate-0 transition-transform">
          ...
          <p className="text-xl md:text-2xl font-bold mb-10 border-4 border-black inline-block px-4 py-2 bg-[#FFFF00]">
            Ditenagai oleh Deep Learning LSTM
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mt-4">
            <button 
              onClick={() => navigate('/login')}
              className="w-full sm:w-auto bg-[#7CFF7C] text-black border-4 border-black px-8 py-4 font-black uppercase text-xl shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[4px] hover:translate-y-[4px] hover:shadow-none transition-all flex items-center justify-center gap-2"
            >
              Mulai Sekarang <ArrowRight size={24} />
            </button>
            <button 
              onClick={() => document.getElementById('lstm-section')?.scrollIntoView({ behavior: 'smooth' })}
              className="w-full sm:w-auto bg-white text-black border-4 border-black px-8 py-4 font-black uppercase text-xl shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[4px] hover:translate-y-[4px] hover:shadow-none transition-all"
            >
      ...
      <section className="px-6 py-20 bg-black text-white">
        <div className="max-w-6xl mx-auto">
          <h3 className="text-4xl md:text-6xl font-black uppercase text-center mb-16 text-[#FFFF00] italic">Kenapa FinPredict?</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Card 1 */}
            <div className="bg-white text-black border-4 border-[#FFFF00] p-8 shadow-[8px_8px_0px_0px_#FFFF00] hover:-translate-y-2 transition-transform">
            ...
            {/* Card 2 */}
            <div className="bg-[#FFFF00] text-black border-4 border-white p-8 shadow-[8px_8px_0px_0px_#FFFFFF] hover:-translate-y-2 transition-transform">
            ...
            {/* Card 3 */}
            <div className="bg-[#7CFF7C] text-black border-4 border-white p-8 shadow-[8px_8px_0px_0px_#FFFFFF] hover:-translate-y-2 transition-transform">
      ...
      <section id="lstm-section" className="px-6 py-20 bg-[#F5F5DC] border-b-8 border-black">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-2">
            {/* Step 1 */}
            <div className="flex-1 bg-white border-4 border-black p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] text-center relative w-full">
            ...
            {/* Step 2 */}
            <div className="flex-1 bg-black text-white border-4 border-black p-6 shadow-[6px_6px_0px_0px_#FFFF00] text-center relative w-full scale-105 z-10">
              <Network size={40} className="mx-auto mb-4 text-[#FFFF00]" />
              <h5 className="font-black uppercase mb-2 text-[#FFFF00]">2. LSTM Layer</h5>
            ...
            {/* Step 3 */}
            <div className="flex-1 bg-[#7CFF7C] border-4 border-black p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] text-center relative w-full">
      ...
      {/* Footer */}
      <footer className="bg-[#FFFF00] p-8 border-t-8 border-black text-center">
