  ...
  return (
    <div className="bg-[#F0F0F0] min-h-screen font-sans text-black p-4 md:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 text-left">
        ...
        <div className="col-span-1 md:col-span-12 lg:col-span-4 bg-[#FFB6C1] border-4 border-black rounded-2xl p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] flex flex-col justify-between">
          <div>
        ...
        <div className="col-span-1 md:col-span-12 lg:col-span-4 bg-[#D4FF00] border-4 border-black rounded-2xl p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
          ...
          <div 
            onClick={() => navigate('/transactions')}
            className="flex items-center gap-2 font-black text-[10px] uppercase underline cursor-pointer hover:bg-black hover:text-[#D4FF00] transition-colors w-fit px-1"
          >
